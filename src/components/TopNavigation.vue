<template>
  <div class="topNavigation">
    <div class="container" style="width:30%;height: 100%;display: flex;">
      <!-- <a href="#"><img id="weibo-icon" src="../assets/img/weibo.png"></a> -->
      <span class="microblog">Microblog</span>
      <div class="search-box">
        <form @mouseleave="stopSearch">
          ...
          <div v-show="searching && query != ''" class="search-result">
            <div class="search-tip" @click="searchWeibo()">
              <div>
          ...
          <div v-show="searching && query == ''" class="search-result">
            ...
            <div class="topic-box" v-for="item of history">
              <i class="el-icon-search search-icon"></i>
              <div class="search-topic search-delab" @click="weiboSearch(item)">{{ item }}</div>
    ...
    <div style="width:35%;height: 100%;">
      <div style="display:flex;width: initial;height: 100%;">
        <router-link class="a1" to="/index">
          <div class="div1">
            <div class="div2">
              <div class="div3">
        ...
        <div style="cursor:pointer" v-else @click="showdialog" class="a1">
          <div class="div1">
            <div class="div2">
              <div class="div3">
            ...
            <div>
              <el-dropdown trigger="click" placement="top">
                ...
                <el-dropdown-menu slot="dropdown">
                  <el-dropdown-item @click.native="set()">账号设置</el-dropdown-item>
...
export default {
  ...
  methods: {
    ...
    userSearch() {
      this.stopSearch();
      this.storeHistory();
      this.$router.push('/user?q=' + this.query + '&ref=user');
    },
    getWeibo(content) {
      this.query = content
